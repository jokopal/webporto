...
var SCHEMA = {
  profile:        { sheet: 'Profile',        mode: 'kv',
                    keys: ['firstName','lastName','greeting','roleChip','availability','headline','summary',
                           'location','coordLabel','email','instagram','linkedin','linkedinHandle','photo'] },
